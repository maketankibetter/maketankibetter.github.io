window.onload = (event) => {
    ...
    addacc.addEventListener('click', () => {
        if (inputacc.value == "" && accounts[0] == "." && inputacc.getAttribute("class") == "accinput"){
            ...
            if (['.', 'game', 'space', 'test', 'new-ru', 'new-en', 'new-de', 'new-pl', 'pages', 'ratings', 'help', 'public-deploy1.test-eu', 'public-deploy2.test-eu', 'public-deploy3.test-eu', 'public-deploy4.test-eu', 'public-deploy5.test-eu', 'public-deploy6.test-eu', 'public-deploy7.test-eu', 'public-deploy8.test-eu', 'public-deploy9.test-eu', 'client-review-1-public.test-ru', 'client-review-2-public.test-ru', 'client-review-3-public.test-ru', 'client-review-4-public.test-ru', 'client-review-5-public.test-ru', 'client-review-6-public.test-ru', 'client-review-7-public.test-ru', 'client-review-8-public.test-ru', 'client-review-9-public.test-ru', 's.eu', 'helpdesk.eu', 'auth', 'war', 'event', 'helper', 'shop', 'mail', 'web-cdn', 'web-temp', 'reward', 'sentry', 'stream', 'summer-game', 'tap', 'test-cn', 'test-moderation-tool', 'test-tankionline-halloween', 'test-tankionline-space', 'test-to-assistant', 'to-assistant', 'treasure-island', 'web-resources', 'graylog', 'htool', 'influxdb', 'lunar-new-year', 'metrics', 'new-year', 'partner-reports', 'rudiscordbot', 'event-dev', 'darkmatter'].includes(inputacc.value)){
